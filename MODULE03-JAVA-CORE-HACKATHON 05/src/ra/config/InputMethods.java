...
public  class InputMethods {
    ...
    public static final String ERROR_PROIDUCTID = "===>> Id sản phẩm phải bắt đầu bằng kí tự P và có đúng 4 kí tự";
    /*========================================Input Method Start========================================*/
    ...
    public static String getProcutId(){
        while (true) {
            String result = getString();
            if(result.startsWith("P")&&result.length()==4){
                return result;
            }
            System.err.println(ERROR_PROIDUCTID);
        }
    }
    /*========================================Other Method========================================*/
}
